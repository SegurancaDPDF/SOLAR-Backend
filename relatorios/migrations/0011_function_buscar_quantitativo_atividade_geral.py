...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('relatorios', '0010_auto_20170613_1500'),
    ]
    ...
    operations = [
        migrations.RunSQL(
            sql="""
                ...
                , cte_atendimento AS (
                    ...
                    */
                    ...
                    INNER JOIN atendimento_atendimento aa ON aa.id = ad.atendimento_ptr_id
                        ...
                        AND (0 = p_comarca_id OR ad.comarca_id = p_comarca_id)
                ...
                , cte_visita AS (
                    ...
                    INNER JOIN contrib_defensoria def ON def.id = ad.defensoria_id
                        AND (0 = p_comarca_id OR def.comarca_id = p_comarca_id)
                ...
                , cte_ae AS (
                    ...
                    INNER JOIN processo_processo pp ON pp.id = ppa.processo_id
                        ...
                        AND (pp.comarca_id = p_comarca_id OR 0 = p_comarca_id)
            ...
            reverse_sql="""DROP FUNCTION
                public.buscar_quantitativo_atividade_geral
        ...
        migrations.RunSQL(
            sql="""
                ...
                ROWS 1000;""",
            reverse_sql="""DROP FUNCTION
                public.buscar_quantitativo_atividade_geral_crosstab
                (integer, integer, integer, integer)"""
        )
    ]
