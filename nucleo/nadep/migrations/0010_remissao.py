    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dias_registro', models.SmallIntegerField(verbose_name='Dias Registro')),
                ('dias_remissao', models.SmallIntegerField(verbose_name='Dias Remiss\xe3o')),
                ('tipo', models.SmallIntegerField(default=0, verbose_name='Tipo', choices=[(0, 'Outros (1/1)'), (1, 'Trabalho (1/3)')])),
