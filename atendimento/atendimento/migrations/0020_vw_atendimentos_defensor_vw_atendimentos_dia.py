...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('atendimento', '0019_auto_20160720_0923'),
    ]

    operations = [
        migrations.RunSQL(
            sql="""
            CREATE OR REPLACE VIEW vw_atendimentos_defensor AS
             SELECT
             ...
             ad.defensor_id,
             (ut.first_name::text || ' '::text) || ut.last_name::text AS defensor_nome,
             ad.substituto_id,
             (us.first_name::text || ' '::text) || us.last_name::text AS substituto_nome,
             ad.responsavel_id,
