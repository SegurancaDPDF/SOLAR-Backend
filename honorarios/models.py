...
class Honorario(models.Model):  # representa um registro de Honorário

    TIPO_NOVO = 0  # definição de constantes para o campo 'situacao'
    TIPO_RECURSO = 1
...
def documento_file_name(instance, filename):  # define o nome do arquivo para upload
    import uuid
...
class Movimento(models.Model):  # representa um Movimento relacionado a um Honorário

    TIPO_ANOTACAO = 0  # Definição de constantes para o campo 'tipo'
...
class Documento(models.Model):  # representa um Documento relacionado a um Movimento
...
class Analise(models.Model):  # representa uma Análise de Honorário relacionada a uma Fase de Processo.
...
class AlertaProcessoMovimento(models.Model):  # representa um alerta de movimentação de Honorário
