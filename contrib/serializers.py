...
class DefensoriaEtiquetaSerializer(serializers.ModelSerializer):  # serializa o modelo DefensoriaEtiqueta em formato JSON
...
class DefensoriaTipoEventoSerializer(serializers.ModelSerializer):  # serializa o modelo defensoriatipoevento em formato JSON
    class Meta:
