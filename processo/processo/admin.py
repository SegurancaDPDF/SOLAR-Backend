...
# classe personalizada para administração da entidade 'Acao'
...
# classe personalizada para administração da entidade 'Assunto'
...
# classe personalizada para administração da entidade 'Audiencia'
...
# classe personalizada para administração da entidade 'DocumentoFase'
...
# classe personalizada para administração da entidade 'DocumentoTipo'
...
# classe personalizada para administração da entidade 'Fase'
...
# classe personalizada para administração da entidade 'FaseTipo'
class FaseTipoAdmin(AuditoriaVersionAdmin):
    search_fields = ('nome', 'nome_norm', 'codigo_cnj', 'codigo_eproc')
    list_display = ('nome', 'codigo_cnj', 'codigo_eproc', 'audiencia', 'juri', 'sentenca', 'recurso', 'judicial',
                    'extrajudicial', '_ativo')
    list_filter = ('judicial', 'extrajudicial', 'audiencia', 'juri', 'sentenca', 'recurso')
