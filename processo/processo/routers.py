...
router.register(r'graus', viewsets.GrauViewSet, basename='graus')
router.register(r'audiencias', viewsets.AudienciaViewSet)
router.register(r'audiencias-totais-por-mes', viewsets.AudienciaTotalViewSet)
...
router.register(r'peticoes-totais-por-mes', viewsets.PeticaoTotalMensalViewSet)
...
router.register(r'processos-tipos-parte', viewsets.ParteTipoViewSet, basename='processos-tipos-parte')
